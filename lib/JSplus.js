...
Object.clone = obj => {
  if (typeof obj !== "object" || obj === null) throw TypeError(obj + " is not an object");
  let clone;
  if (typeof obj[Symbol.iterator] === "function") {
    if (obj.constructor.from) clone = obj.constructor.from(obj);
    else clone = new obj.constructor();
  }
  else clone = new obj.constructor();
  for (let key of Object.keys(obj)) {
    if (typeof obj[key] === "object") clone[key] = Object.clone(obj[key]);
